<?php
    ...
    function custom_meta_title($data){
        return __('Change username', 'osclassclsx');;
    }
    osc_current_web_theme_path('header.php') ;
    $osc_user = osc_user();
?>
<h1><?php _e('Change username', 'osclassclsx'); ?></h1>
    ...
    <div class="resp-wrapper">
        ...
        <form action="<?php echo osc_base_url(true); ?>" method="post" id="change-username">
            ...
            <div class="control-group">
                <label class="control-label" for="s_username"><?php _e('Username', 'osclassclsx'); ?></label>
                <div class="controls">
