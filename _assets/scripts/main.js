...
bender.toggleClass = function(element,destination,isObject) {
    ...
    $selector.click(function (event) {
        ...
        if (typeof(isObject) != "undefined"){
            thatDestination  = $(destination);
        } else {
            thatDestination  = $($(this).attr(destination));
        }
...
window.onload = function() {
    ...
    var resize  = function(offset) {
        offset= !window.opera ? (this.offsetHeight - this.clientHeight) : (this.offsetHeight + parseInt(window.getComputedStyle(t, null).getPropertyValue('border-top-width'))) ;
